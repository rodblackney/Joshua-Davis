...
public class sketch_6_11 extends PApplet {
...
public void setup() {
	...
	H.add(r1).anchor(50, -50).loc(pt1.x, pt1.y).stroke(0xff000000, 100).fill(0xffFF3300).rotation(45);
...
//	ellipse(pt4.x, pt4.y, 4, 4); // point b ellipse
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_6_11" };
    if (passedArgs != null) {
