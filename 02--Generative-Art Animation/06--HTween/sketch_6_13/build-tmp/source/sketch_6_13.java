...
public class sketch_6_13 extends PApplet {
...
public void draw() {
	...
	pointLight(204, 204, 204,  0, height/2, -50);
	pointLight(204, 204, 204,  width, height/2, -100);
	pointLight(255, 255, 255,  width/2, 100, 150);
...
//	ellipse(pt4.x, pt4.y, 4, 4); // point b ellipse
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_6_13" };
    if (passedArgs != null) {
