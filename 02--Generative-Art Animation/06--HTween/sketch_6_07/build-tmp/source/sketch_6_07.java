...
public class sketch_6_07 extends PApplet {
...
public void setup() {
	...
	r1.add(r2).anchorAt(H.CENTER).noStroke().fill(0xffFF6600);

	r3 = new HRect(25);
	r1.add(r3).anchorAt(H.CENTER).noStroke().fill(0xff00616F)
		;				
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_6_07" };
    if (passedArgs != null) {
