...
public class sketch_3_06 extends PApplet {
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_3_06" };
    if (passedArgs != null) {
