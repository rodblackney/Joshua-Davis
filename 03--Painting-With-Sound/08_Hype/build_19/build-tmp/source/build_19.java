...
public class build_19 extends PApplet {
...
//		i++;
		...
		// display random numbers picked
		fill(0xffFF3300); textSize(12); textAlign(CENTER); text(i, d.x(), height/2 + 100);
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "build_19" };
    if (passedArgs != null) {
