...
public void setup() {
	...
	pool.autoAddToStage()
		.add ( new HShape("hex_1.svg").enableStyle(false).strokeJoin(CENTER).strokeCap(CENTER) )
		.add ( new HShape("hex_2.svg").enableStyle(false).strokeJoin(CENTER).strokeCap(CENTER) )
		.add ( new HShape("hex_3.svg").enableStyle(false).strokeJoin(CENTER).strokeCap(CENTER) )
		.onCreate (
			new HCallback() {
